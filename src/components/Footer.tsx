  ...
  const footerLinks = [
    {
      ...
      links: [
        ...
        { label: "Prizes", href: "#" },
        { label: "FAQ", href: "https://legroupeds.com/community", external: true },
        { label: "Terms & Conditions", href: "https://legroupeds.com/terms-and-conditions", external: true },
      ],
    },
    {
      title: "Events",
    ...
    },
    {
      title: "DS Consortium",
      links: [
        { label: "About Us", href: "https://legroupeds.com/about", external: true },
        { label: "Our Mission", href: "https://legroupeds.com/services/knowledge-lab", external: true },
        { label: "Contact", href: "https://legroupeds.com/contact", external: true },
        { label: "Privacy Policy", href: "https://legroupeds.com/privacy", external: true },
      ],
    },
  ];
